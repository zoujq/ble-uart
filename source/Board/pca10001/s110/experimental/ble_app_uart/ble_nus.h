...
#define BLE_UUID_NUS_SERVICE            0xFEE0                       /**< The UUID of the Nordic UART Service. */
#define BLE_UUID_NUS_RX_TX_CHARACTERISTIC  0xFEE1                       /**< The UUID of the RX TX Characteristic. */
#define BLE_UUID_NUS_TX_CHARACTERISTIC  0xFEE2                       /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC  0xFEE3                       /**< The UUID of the RX Characteristic. */
...
/**@brief   Nordic UART Service structure.UART服务结构
 *
 * @details This structure contains status information related to the service.此结构包含与所述服务的状态信息
 */
typedef struct ble_nus_s
{
    ...
    ble_gatts_char_handles_t rx_tx_handles;              /**< Handles related to the RX characteristic. (as provided by the S110 SoftDevice)*/
